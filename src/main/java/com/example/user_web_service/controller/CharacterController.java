...
public class CharacterController {
    ...
    public ResponseEntity<ResponseObject> createCharacter(
        ...
        if(gameTokenForm.getGameToken() == null || gameTokenForm.getGameToken().isBlank() || gameTokenForm.getGameToken().isEmpty() ||
                characterName == null || characterName.isEmpty() || characterName.isBlank() ||
        ...
        return characterService.creatCharacter(gameTokenForm,characterName.trim(), gameName.trim(), serverName.trim());
    }
